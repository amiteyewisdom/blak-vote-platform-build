    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10">
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-border/70 bg-card/95 p-6 shadow-[0_24px_80px_hsl(var(--foreground)/0.12)] sm:p-10">
        <div className="mb-10 flex flex-col items-center text-center">
          ...
          <h1 className="mt-6 text-3xl font-semibold tracking-tight text-foreground">Self-service signup is unavailable</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            Account creation is handled by the BlakVote team. Contact us and we will provision the correct access for you.
          </p>
        </div>
